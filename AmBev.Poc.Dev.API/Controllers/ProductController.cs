...
namespace AmBev.Poc.Dev.API.Controllers
{
    ...
    public class ProductController : ApiControlleBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ResponseBaseModel<int>>> Post([FromBody] ProductCreateModel productModel) => GetResponse(await _productService.CreateProduct(productModel));
