...
namespace AmBev.Poc.Dev.API.Controllers
{
    ...
    public class CustomerController : ApiControlleBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ResponseBaseModel<CustomerModel>>> Get() => GetResponse(await _customerService.GetAllCustomer());
        ...
        [HttpPost]
        public async Task<ActionResult<ResponseBaseModel<bool>>> Post([FromBody] CustomerModel customerModel) => GetResponse(await _customerService.CreateCustomer(customerModel));

        [HttpPut("{id}")]
        public async Task<ActionResult<ResponseBaseModel<CustomerModel>>> Updated([FromBody] CustomerUpdateModel customerModel) => GetResponse(await _customerService.UpdateCustomer(customerModel));
